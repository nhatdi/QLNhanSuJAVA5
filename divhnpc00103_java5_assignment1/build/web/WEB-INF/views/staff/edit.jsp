<%-- 
    Document   : edit
    Created on : Apr 11, 2020, 8:44:28 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        <div class="bg-img">
            <fDi:form class="formDn1" action="staff/save.htm" modelAttribute="Staff">
                ...
                <br/>
                <br/>
                <input class="btn1" type="submit" name="btnAction" value="Save"/>
