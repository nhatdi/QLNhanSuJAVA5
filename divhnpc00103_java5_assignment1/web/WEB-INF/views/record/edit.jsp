<%-- 
    Document   : edit
    Created on : Feb 25, 2020, 4:33:16 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        <div class="bg-img">
            ...
            <fDi:form class="formDn1" action="record/save.htm" modelAttribute="Record">
                ...
                <br/>
                <br/>
                <input class="btn2" type="submit" name="action" value="Save"/>
